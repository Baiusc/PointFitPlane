...
point1_1Actor.GetProperty().SetColor(r,g,b)
...
point6_1Actor.GetProperty().SetColor(r,g,b)
...
point6_2Actor.GetProperty().SetColor(r,g,b)
...
point6_3Actor.GetProperty().SetColor(r,g,b)
...
point6_4Actor.GetProperty().SetColor(r,g,b)
...
point6_5Actor.GetProperty().SetColor(r,g,b)
...
point6_6Actor.GetProperty().SetColor(r,g,b)
...
point2_1Actor.GetProperty().SetColor(r,g,b)
...
point2_2Actor.GetProperty().SetColor(r,g,b)
...
point5_1Actor.GetProperty().SetColor(r,g,b)
...
point5_2Actor.GetProperty().SetColor(r,g,b)
...
point5_3Actor.GetProperty().SetColor(r,g,b)
...
point5_4Actor.GetProperty().SetColor(r,g,b)
...
point5_5Actor.GetProperty().SetColor(r,g,b)
...
point4_1Actor.GetProperty().SetColor(r,g,b)
...
point4_2Actor.GetProperty().SetColor(r,g,b)
...
point4_3Actor.GetProperty().SetColor(r,g,b)
...
point4_4Actor.GetProperty().SetColor(r,g,b)
...
point3_1Actor.GetProperty().SetColor(r,g,b)
...
point3_2Actor.GetProperty().SetColor(r,g,b)
...
point3_3Actor.GetProperty().SetColor(r,g,b)
